...
class BillClass:
    def __init__(self,root):
        ...
        footer=Label(self.root,text="IMS-Inventory Management System | Developed By Smit Ela\nFor any Technical Issue contact:9682318133,6006447249,7780866525",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#=============All Functions============
    ...
    def bill_top(self):
        ...
        bill_top_temp=f''''
\t\t3 EDIOTS-Inventory
\t Phone No. 6006447249,9682318133
\t\tSRINAGAR-190001
{str("="*47)}
