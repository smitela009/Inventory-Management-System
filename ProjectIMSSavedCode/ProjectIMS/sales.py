...
class salesClass:
    def __init__(self,root):
      ...
      ##title
      lbl_title=Label(self.root,text="View Customer Bills",font=("goudy style old",20,"bold"),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=10)
      ...
      lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy style old",20,"bold"),bg="orange").pack(side=TOP,fill=X)
      ...
      self.bill_photo=self.bill_photo.resize((450,300),Image.Resampling.LANCZOS)#Image.ANTIALIAS
      self.bill_photo=ImageTk.PhotoImage(self.bill_photo)

      lbl_image=Label(self.root,image=self.bill_photo,bd=0)
      lbl_image.place(x=700,y=140,height=330)
